...
export default function ProductCard({
  ...
  return (
    <div className="lg:max-w-sm max-w-[300px] bg-white shadow-md rounded-lg overflow-hidden border border-gray-100">
      <img src={image} alt={label} className="w-full h-56 object-cover" />
      <div className="p-4">
        <h3 className="text-xl  text-gray-900 mb-2">{label}</h3>
        <p className="text-lg leading-normal text-gray-700 mb-4">
          {description}
        </p>
        <a
          href={href}
